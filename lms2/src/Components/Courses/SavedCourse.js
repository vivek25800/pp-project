...
import SavedCourseListTwo from './SavedCourseListTwo'
                ...
                <div className='main-content-div'>
                    ...
                    <section className='all-activity-content'>
                        <div className='all-content-options'>
                           ...
                           <button style={{backgroundColor:"#7A1CAC", color:"#ffffff"}}><NavLink to={'/savedCourse'}>Saved (10)</NavLink></button>
                           <button >My Collections</button>
                           <button><NavLink to={'/learningHistory'}>Learning History</NavLink></button>
                        </div>
