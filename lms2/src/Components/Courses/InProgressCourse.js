                ...
                <div className='main-content-div'>
                    ...
                    <section className='all-activity-content'>
                        <div className='all-content-options'>
                           <button className='progress-btn' style={{backgroundColor:"#7A1CAC", color:"#ffffff"}}> <NavLink to={'/progreesCourse'}>In Progress (1)</NavLink> </button>
                           <button className='saved-btn'> <NavLink to={'/savedCourse'}>Saved (10)</NavLink> </button>
                           <button className='collections-btn'> My Collections</button>
                           <button className='history-btn'> <NavLink to={'/learningHistory'}>Learning History</NavLink></button>
                        </div>
