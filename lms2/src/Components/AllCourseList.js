        ...
        <div style={{backgroundColor: "rgba(46, 7, 63, 0.1)", padding: "20px"}}>
            ...
            <div className='header-div header-two'>
                <div className='title-name'>
                    <h5>Course List</h5>
                    <p style={{opacity: "0.5"}}>All Course Here</p>
                </div>
                <div className="category-btn">
                    <button> <NavLink to={'/CreateNewCourse'}>Add Course</NavLink> </button>
                </div>
            </div>
                ...
                <table style={{padding: "1rem"}}>
                    <thead>
                        <tr style={{borderTop: "none"}}>
                            <th style={{paddingRight: "16rem"}}>Course Title</th>
                            <th style={{paddingRight: "5rem"}}>Price</th>
                            <th style={{paddingRight: "5rem"}}>Validity</th>
                            <th style={{paddingRight: "14rem"}}>Progress</th>
                            <th>Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            ...
                            <td>Life time</td>
                            <td>
                                <div className="progress" style={{width: "80%", height: "14px"}}>
                        ...
                        <tr>
                            ...
                            <td>
                                <div className="progress" style={{width: "80%", height: "14px"}}>
                                    <div className="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow={40} aria-valuemin={0} aria-valuemax={100} style={{ width: "55%" }}>
                                        55%
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div className="progress" style={{width: "80%", height: "14px"}}>
                                    <div className="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow={40} aria-valuemin={0} aria-valuemax={100} style={{ width: "50%" }}>
                                        50%
                                    </div>
                                </div>
                            </td>
                        ...
                        <td>Paid</td>
                            ...
                            <td>
                                <div className="progress" style={{width: "80%", height: "14px"}}>
                                    <div className="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow={40} aria-valuemin={0} aria-valuemax={100} style={{ width: "64%" }}>
                                        64%
                                    </div>
                                </div>
                            </td>
                        ...
                        <td>Paid</td>
                            ...
                            <td>
                                <div className="progress" style={{width: "80%", height: "14px"}}>
                                    <div className="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow={40} aria-valuemin={0} aria-valuemax={100} style={{ width: "72%" }}>
                                        72%
                                    </div>
                                </div>
                            </td>
